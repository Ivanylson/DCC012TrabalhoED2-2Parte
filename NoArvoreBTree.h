...
public:
    NoArvoreBTree(int tamanho, bool folha);
    ~NoArvoreBTree();
    ...
    NoArvoreBTree** getFilhos();
    void setFilhos(NoArvoreBTree* filho, int i);

    void salvaArquivo(TabelaHash *registros,int nivel, ofstream &saida);

    void print(TabelaHash *registros,int nivel);


};
#endif // NOARVOREBTREE_H_INCLUDED
